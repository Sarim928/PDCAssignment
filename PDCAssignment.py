...
fees_data_path = 'C:/Users/Sarim/Documents/Fees_data.csv'
students_data_path = 'C:/Users/Sarim/Documents/Students_data.csv'
...
# Prepare the list of student names based on your dataset
students_to_process = [
    ("John", "Doe"),
    ("Jane", "Smith"),
    ("Sarah", "Thomas"),
